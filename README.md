...
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=hashnode&logoColor=white&label=Meu%20Portfólio)](https://angelomarcos.github.io/Portfolio/)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white&label=Conecte-se)](https://www.linkedin.com/in/angelo-marcos-116122181/)
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white&label=Seguir)](https://github.com/AngeloMarcos)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white&label=Contato)](mailto:angelobispofilho@gmail.com)
[![WhatsApp](https://img.shields.io/badge/WhatsApp-25D366?style=for-the-badge&logo=whatsapp&logoColor=white&label=11991909106)](https://wa.me/5511991909106)
...
Sistema de gestão hospitalar com prontuário eletrônico, agendamento inteligente, controle financeiro, faturamento integrado e dashboard gerencial em tempo real para modernizar a administração médica.
...
Sistema completo de CRM com gestão de leads, propostas, funil de vendas, controle financeiro, relatórios inteligentes e automação de fluxos comerciais para otimizar processos de vendas B2B.
...
Sistema de PDV com controle de estoque em tempo real, gerenciamento de fornecedores, relatórios de lucratividade e integração com meios de pagamento para varejo físico e online.
...
**Projetos desenvolvidos:**
- **Agente Angelo Marcos IA** - Atendimento automatizado 24h com qualificação de leads, agendamento inteligente, histórico de conversas e RAG
- **Sistema de Disparo Inteligente** - Processamento em lote com tratamento de erros, retry automático e atualização de status em tempo real
- **Agregador de Dados com IA** - Pipeline de coleta, processamento e análise de conversas com IA para gerar relatórios e resumos automatizados
...
**março de 2025 - fevereiro de 2026 · 1 ano · São Paulo, Brasil · No local**
...
- ✅ Melhoria da eficiência operacional com redução de tempo de suporte
...
**junho de 2023 - dezembro de 2024 · 1 ano 7 meses · São Paulo, Brasil · No local**

Desenvolvimento e manutenção de soluções front-end para a plataforma PRODESP (Governo do Estado de SP).

**Principais realizações:**
- ✅ Desenvolvi e mantive interfaces web para plataformasp.com.br
- ✅ Implementei 15+ features e corrigi 50+ bugs críticos
- ✅ Integrei APIs REST e implementei melhorias de performance
- ✅ Aumento na estabilidade e performance da plataforma
...
**dezembro de 2022 - maio de 2023 · 6 meses · São Paulo, Brasil**

Suporte técnico especializado no sistema hospitalar AGHU para hospitais da zona leste de São Paulo.

**Principais realizações:**
- ✅ Suporte técnico ao sistema hospitalar AGHU em 30+ hospitais
- ✅ Treinamento e suporte a 100+ usuários finais
- ✅ Monitoramento de servidores e infraestrutura
- ✅ Gerenciamento de bancos de dados hospitalares
- ✅ Melhoria na disponibilidade do sistema e redução do tempo de inatividade

**Tecnologias:** AGHU, PostgreSQL, DNS, HTML, Servidores, Help Desk

---

### **Suporte TI Júnior**
**BDS DataSolution** | Tempo integral  
**novembro de 2021 - dezembro de 2022 · 1 ano 2 meses · São Paulo, Brasil**

Suporte técnico em empresa fornecedora de dados de mercado financeiro para bancos.

**Principais realizações:**
- ✅ Assegurei atualização e integridade de dados financeiros críticos
- ✅ Trabalhei com aplicações BDS e banco de dados SQL
- ✅ Configurações de BAT, sistema de chamados, Trello
- ✅ Utilizei XHTML, Github, Microsoft Azure, Python e servidores cloud
- ✅ Mantive SLA de 95% na resolução de incidentes

**Tecnologias:** SQL, Python, Microsoft Azure, XHTML, GitHub, BAT Scripts

---

### **Desenvolvedor Trainee ASP.NET**
**Softarte Assessoria e Informática** | Tempo integral  
**agosto de 2020 - novembro de 2021 · 1 ano 4 meses · São Paulo, Brasil**

Desenvolvimento e manutenção de sistema ERP para joalheria e construção.

**Principais realizações:**
- ✅ Desenvolvi sistema ERP operando em cloud
- ✅ Manutenções e desenvolvimento de novas ferramentas
- ✅ Atuação em front-end (HTML/CSS) e back-end (ASP, SQL)
- ✅ Implementei funcionalidades que aumentaram eficiência operacional

**Tecnologias:** ASP.NET, HTML5, CSS, SQL Server, Cloud Computing

---

### **Desenvolvedor Front-end**
**Freelance/Projeto Paralelo**  
**fevereiro de 2021 - setembro de 2021 · 8 meses · São Paulo, Brasil**

Desenvolvimento de interfaces web para diversos clientes.
...
**Vocalcom** | Tempo integral  
**janeiro de 2019 - outubro de 2019 · 10 meses · São Paulo, Brasil**

Suporte técnico em sistema de Contact Center omnicanal HERMES.

**Principais realizações:**
- ✅ Suporte e auxílio aos usuários do sistema HERMES
- ✅ Mantive integridade e disponibilidade do sistema
- ✅ Monitoramentos diários no ZABBIX
- ✅ Consultas e manipulações de dados SQL
- ✅ Geração de relatórios diários de performance

**Tecnologias:** HERMES, ZABBIX, SQL, Contact Center Systems
...
### **TripleTen**
**Tecnologia em Informática/Software**  
...
Graduação tecnológica focada em desenvolvimento de software e sistemas.
...
Formação complementar em análise e desenvolvimento de sistemas.

---

### **ETEC - Escola Técnica Estadual de São Paulo**
**Programação de Computadores - Aplicativos Específicos**  
**janeiro de 2017 - dezembro de 2018**

Curso técnico com foco em programação e desenvolvimento de aplicativos.
...
Primeiro emprego como analista de suporte júnior após conclusão do curso.
...
![Microsoft%20Azure](https://img.shields.io/badge/Microsoft%20Azure-0089D6?style=for-the-badge&logo=microsoft-azure&logoColor=white)
...
✅ **5+ anos de experiência** em suporte técnico e desenvolvimento  
✅ **Experiência prática em ambientes críticos** (hospitais, governo, setor financeiro)  
...
✅ **Experiência comprovada em suporte, desenvolvimento e automação**  
...
![Experience](https://img.shields.io/badge/Experience-5%2B%20anos-blue?style=for-the-badge)
...
![Projects](https://img.shields.io/badge/Projects-15%2B%20Concluídos-green?style=for-the-badge)
...
Sou um profissional apaixonado por tecnologia com 5+ anos de experiência combinando suporte técnico, desenvolvimento de software e automação de processos. Tenho histórico comprovado de resolver problemas complexos em ambientes críticos (hospitais, governo, setor financeiro), automatizar workflows e desenvolver soluções que geram valor real para usuários e empresas.
